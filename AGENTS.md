...
- **Export `version_table/0`** so `mix phoenix_kit_hello_world.audit_migrations` can verify the marker really carries a version (bare number or namespaced) without hard-coding your table name.
